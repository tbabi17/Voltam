<?
	...
	if (isset($mac)) {
		...
		if($gmailAccount == 1){
			if($pk == 'dashboard' || $pk != 'goal' && $pk != 'services' && $pk != 'corporate' && $pk != 'reports' && $pk != 'product') $pk = 'dashboard';
			if($pk == 'services' || $pk != 'goal' && $pk != 'corporate' && $pk != 'reports' && $pk != 'dashboard' && $pk != 'product') $pk = 'services' ;
		//	if($pk == 'goal' || $pk != 'services' && $pk != 'corporate' && $pk != 'reports' && $pk != 'dashboard') $pk = 'goal';
			if($pk == 'corporate' || $pk != 'goal' && $pk != 'services' && $pk != 'reports' && $pk != 'dashboard' && $pk != 'product') $pk = 'corporate';
			//if($pk == 'reports' || $pk != 'goal' && $pk != 'services' && $pk != 'corporate' && $pk != 'dashboard' && $pk != 'product') $pk = 'reports';
			if($pk == 'product' || $pk != 'goal' && $pk != 'services' && $pk != 'corporate' && $pk != 'dashboard' && $pk != 'reports') $pk = 'product';
		}
