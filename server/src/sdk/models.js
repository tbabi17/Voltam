fields['CRM_USER_PLANNING_FIELDS'] = [
   ...
   {name: 'count', text: 'Т.Дүн', type: 'float', width: 90, renderer: renderNumber, align: 'right', summaryRenderer: renderTNumber, summaryType: 'sum', 
	editor: {
		xtype: 'numberfield', 
		allowBlank: false		
	}
...
fields['CRM_PRODUCT_FIELDS'] = [
   ...
   {name: 'product_code', text: 'Код', width: 60, align:'center', primary: true}, 
   {name: 'product_barcode', text: 'Баркод', align:'center', width: 90, primary: true}, 
   {name: 'product_name', text: 'Нэр', width:150, primary: true},   
   {name: 'product_type', text: 'Төрөл', width:150},   
   {name: 'product_brand', text: 'Бренд', width: 80},
   {name: 'product_vendor', text: 'Үйлдвэрлэгч', width: 80},
   {name: 'price', text: price_text[0], type: 'float', width: 80, renderer: renderMoney, align: 'right'},
